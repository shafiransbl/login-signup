          ...
          <div class="row">
            <div class="col-md-7">
              ...
              <div class="btn-welcome">
                <button type="button" class="btn btn-primaryHome me-2" 
        onclick="window.location.href='https://padlet.com/oranjieboo/peara-store-pricelist-f9re01py8m4cv1vy'">Check Pricelist</button>
                <button type="button" class="btn btn-primaryHome me-2" 
        onclick="window.location.href='http://wa.me/6285776691536'">Order on Here!</button>
            </div>
        </div>
            <div class="col-md-5">
              <img src="IMG/Ava (2).png" class="img-fluid" alt="Peara Store">
            </div>
          </div>
        </div>
      </div>
